    ...
    <section>
        <div class="container">
            <div class="login-container">
                ...
                <span style="color: green; text-align: center;">Check out the now working Reset Password page!<br /> <span style="color: red !important;">I accidentally set everyones password to 123123123123 lmao. You're gonna have to reset the password with forget password.</span></span>
