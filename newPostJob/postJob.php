            ...
            if (isset($_POST['budgetoption'])) {
                if (!empty($_SESSION['post'])) {
                    if (empty($_POST['budgetoption'])) {
                        ...
                        $sql = "INSERT INTO jobs(length,title,skills,size,location,budget,rate,description,image,user_id,freelancer_id,status, datePosted) VALUES('$length','$title','$skills','$size','$location','$maxbudget','$hourrate', '$description', '$imgUpload', '$userID',0,0, '$datePosted')";
